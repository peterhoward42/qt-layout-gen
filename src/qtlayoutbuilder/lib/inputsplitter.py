...
class FileSplitIntoRecords(object):
    """
    Offers the service of extracting the InputTextRecords produced
    by parsing a given file.
    """
...
def _split_all_files_in_directory_into_records(directory_path):
    ...
    for file_to_split in files:
        records = FileSplitIntoRecords(file_to_split).split()
