...
class TestDirectorySearch(TestCase):
    ...
    def test_finds_all_files_expected(self):
        ...
        file_names_alone = [os.path.basename(file) for file in files]
    ...
    def test_treats_empty_result_as_error(self):
        ...
        self.assertTrue(message.startswith('No files found'), 'Message: %s, does not start as it should' % message)
